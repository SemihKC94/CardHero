...
namespace FG.Utils
{
    ...
    public class UI_Sprite
    {
        ...
        {
            UI_Sprite uiSprite = new UI_Sprite(GetCanvasTransform(), FG_Assets.i.s_White, anchoredPosition, size, color);
        ...
        {
            rectTransform = FG_Utils.DrawSprite(sprite, parent, anchoredPosition, size, "UI_Sprite");
