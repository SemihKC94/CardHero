...
public class FG_LevelManager : MonoBehaviour
{
    [Header("Levels")]
    [SerializeField] private List<FG_LevelSO> levelDatas = null;
    ...
    public static FG_LevelManager Instance { get; private set; }
