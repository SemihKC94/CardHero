...
public class GameManager : MonoBehaviour
{
    ...
    private void OnFail()
    {
        DataManager.SaveData(Constants.General.SAVE_DATA, SaveData);
    ...
    private IEnumerator Initialize()
    {
        ...
        uniqueLevelCount = FG_LevelManager.Instance.LevelsCount();
        guiController.Init();
    ...
    {
        var savedData = DataManager.LoadData<SaveData>(Constants.General.SAVE_DATA);
