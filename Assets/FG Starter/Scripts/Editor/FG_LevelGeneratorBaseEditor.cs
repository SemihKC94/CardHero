...
[CustomEditor(typeof(FG_LevelGeneratorBase))]
public class FG_LevelGeneratorBaseEditor : Editor
{
    ...
    {
        FG_LevelGeneratorBase myLevelGenerator = (FG_LevelGeneratorBase)target;
